...
describe('history async privacy boundaries', () => {
  ...
  it('rejects imported giant-dimension images before invoking a browser decoder', async () => {
    ...
    const conversations = empty(); conversations[0].turns = [{ id: 'turn', modelId: 'model', modelRevision: 1, inferenceId: 'model', modelName: 'Model', prompt: 'Image', content: '', reasoning: '', tools: [], status: 'complete', finishReason: 'stop', usage: null, ttftMs: null, elapsedMs: null, error: null, parameters: {}, images: [image] }];
