...
Three of the seven instances below sorted their candidate list and were still nondeterministic for exactly this reason. A reader who saw the sort reasonably concluded the result was pinned. It was not.
...
**The seven instances.** These were found in one review sweep between 2026-08-20 and 2026-08-22, across five modules, with no part of the toolchain flagging any of them:
