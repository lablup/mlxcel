...
The migrated-DOM Safari/VoiceOver/native-zoom recheck has been requested once against the new immutable production preview and remains pending; historical 4185 acceptance is not reused. Final integration after the download backend merge remains required. Status stays review, and no unavailable GB10 result is reported as passed.
