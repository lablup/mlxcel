...
- New unit tests, `--profile test-fast --features cuda`: `vision::llmjp_vl` 6/6, `multimodal::llmjp_vl_prompt` (including the parity gate) 8/8, `loading::vlm::llmjp_vl` 7/7, `server::llmjp_chat_template_tests` 5/5, the detection test 1/1, `models::metadata_tests` 4/4.
