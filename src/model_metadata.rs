...
macro_rules! for_each_model_registration {
    ($macro:ident) => {
        $macro! {
            ...
            UnlimitedOcrVLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("Unlimited-OCR VLM cannot be loaded with LoRA adapters yet") };
            ...
            HunyuanVLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("Hunyuan-VL cannot be loaded with LoRA adapters yet") };
            ...
            GotOcrVLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("GOT-OCR 2.0 does not support adapter loading; use load_model() instead") };
            ...
            Florence2VLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("Florence-2 does not support adapter loading; use load_model() instead") };
            ...
            MiniMaxM3VL => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("MiniMax-M3-VL cannot be loaded with LoRA adapters yet") };
            MuseGlimmerVLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("Muse Glimmer VLM cannot be loaded with LoRA adapters yet") };
            ...
            Dbrx => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::DbrxModel::load, args: models::dbrx::ModelArgs, weight_builder: models::DbrxModel::from_weights, wrap: LoadedModel::Dbrx } };
            ...
            DeepSeekV4 => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::DeepSeekV4Model::load, args: models::deepseek_v4::ModelArgs, weight_builder: models::DeepSeekV4Model::from_weights, wrap: LoadedModel::DeepSeekV4 } };
            ...
            Cohere2Moe => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::Cohere2MoeModel::load, args: models::cohere2_moe::Cohere2MoeConfig, weight_builder: models::Cohere2MoeModel::from_weights, wrap: LoadedModel::Cohere2Moe } };
            ...
            BailingMoe => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::BailingMoeModel::load, args: models::bailing_moe::ModelArgs, weight_builder: models::BailingMoeModel::from_weights, wrap: LoadedModel::BailingMoe } };
            BailingMoeLinear => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::BailingMoeLinearModel::load, args: models::bailing_moe_linear::ModelArgs, weight_builder: models::BailingMoeLinearModel::from_weights, wrap: LoadedModel::BailingMoeLinear } };
            Klear => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::KlearModel::load, args: models::klear::ModelArgs, weight_builder: models::KlearModel::from_weights, wrap: LoadedModel::Klear } };
            Afmoe => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::AfmoeModel::load, args: models::afmoe::ModelArgs, weight_builder: models::AfmoeModel::from_weights, wrap: LoadedModel::Afmoe } };
            ...
            OpenElm => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::OpenElmModel::load, args: models::openelm::ModelArgs, weight_builder: models::OpenElmModel::from_weights, wrap: LoadedModel::OpenElm } };
            Gpt2 => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::Gpt2Model::load, args: models::gpt2::ModelArgs, weight_builder: models::Gpt2Model::from_weights, wrap: LoadedModel::Gpt2 } };
            GptBigCode => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::GptBigCodeModel::load, args: models::gpt_bigcode::ModelArgs, weight_builder: models::GptBigCodeModel::from_weights, wrap: LoadedModel::GptBigCode } };
            GptNeoX => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::GptNeoxModel::load, args: models::gpt_neox::ModelArgs, weight_builder: models::GptNeoxModel::from_weights, wrap: LoadedModel::GptNeoX } };
            Helium => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::HeliumModel::load, args: models::helium::ModelArgs, weight_builder: models::HeliumModel::from_weights, wrap: LoadedModel::Helium } };
            TeleChat3 => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::TeleChat3Model::load, args: models::telechat3::ModelArgs, weight_builder: models::TeleChat3Model::from_weights, wrap: LoadedModel::TeleChat3 } };
            ...
            Laguna => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::LagunaModel::load, args: models::laguna::ModelArgs, weight_builder: models::LagunaModel::from_weights, wrap: |m| LoadedModel::Laguna(models::LagunaWrapper::new(m)) } };
            ...
            KimiK3 => { kind: Text, directory: Nonstandard, weight: Some(WeightLoadRoute::Special), adapter: None };
            KimiK3VLM => { kind: Vlm, directory: Vlm, weight: None, adapter: Some("Kimi K3 VLM does not support adapter loading; use load_model() instead") };
