...
macro_rules! for_each_model_registration {
    ($macro:ident) => {
        $macro! {
            ...
            DeepSeekV4 => { kind: Text, directory: ConfigBacked, weight: Some(WeightLoadRoute::ConfigBacked), adapter: None, config_backed: { dir_loader: models::DeepSeekV4Model::load, args: models::deepseek_v4::DeepSeekV4Config, weight_builder: models::DeepSeekV4Model::from_weights, wrap: LoadedModel::DeepSeekV4 } };
