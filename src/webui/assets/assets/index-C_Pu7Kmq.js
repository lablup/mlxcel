      ...
      "ModelIdentity": {
        ...
        "properties": {
          ...
          "display_name": {
            ...
            "minLength": 1,
            "maxLength": 256,
            "description": "The model's inference id verbatim, with no character rewriting (the full owner/name for cache entries). A label only: select and operate on a model by id."
          },
          "source": {
            "$ref": "#/components/schemas/CatalogSourceKind"
          },
