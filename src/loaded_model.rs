...
pub enum LoadedModel {
    ...
    Ernie45MoeVLM(vision::ernie4_5_moe_vl::Ernie45MoeVlModel),
    HunyuanVLM(vision::hunyuan_vl::HunyuanVlModel),
    MiniMaxM3VL(vision::MiniMaxM3VlModel),
    MuseGlimmerVLM(vision::MuseGlimmerVlmModel),
    InklingVLM(vision::InklingVlModel),
    ...
    UnlimitedOcrVLM(vision::unlimited_ocr::UnlimitedOcrVlModel),
    ...
    CohereCompassVLM(vision::CohereCompassModel),
    Qwen3OmniMoe(vision::qwen3_omni_moe::Qwen3OmniMoeModel),
    PaddleOcrVL(vision::PaddleOcrVlModel),
    Step3p7VL(vision::Step3p7VlModel),
    DotsOcrVL(vision::DotsOcrVlModel),
    FalconOcrVL(vision::FalconOcrVlModel),
    JinaVLM(vision::JinaVlmModel),
    ...
    BailingMoe(models::BailingMoeModel),
    BailingMoeLinear(models::BailingMoeLinearModel),
    Afmoe(models::AfmoeModel),
    Klear(models::KlearModel),
    ...
    OpenElm(models::OpenElmModel),
    Gpt2(models::Gpt2Model),
...
macro_rules! delegate_language_model {
    ($self:expr, $method:ident ( $($arg:expr),* $(,)? )) => {
        match $self {
            ...
            LoadedModel::Ernie45MoeVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::HunyuanVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::MiniMaxM3VL(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::MuseGlimmerVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::InklingVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::UnlimitedOcrVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::CohereCompassVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::Qwen3OmniMoe(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::PaddleOcrVL(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::Step3p7VL(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::DotsOcrVL(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::FalconOcrVL(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::JinaVLM(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::Phixtral(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::Dbrx(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::DeepSeekV4(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::Cohere2Moe(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::BailingMoe(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::BailingMoeLinear(inner) => LanguageModel::$method(inner, $($arg),*),
            ...
            LoadedModel::OpenElm(inner) => LanguageModel::$method(inner, $($arg),*),
            LoadedModel::Gpt2(inner) => LanguageModel::$method(inner, $($arg),*),
